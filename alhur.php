							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									<li class="hassubs">
										...
										<ul>											
											<li><a href="#">Pojok MIPA<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="#">Graha Widya Wisuda<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="#">Masjid Al-Hurriyyah<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="#">Perpustakaan LSI<i class="fas fa-chevron-right"></i></a></li>
										</ul>
									</li>
									...
									<li class="hassubs">
										...
										<ul>											
											<li><a href="#">Gadget<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="#">Dompet<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="#">Alat Tulis<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="#">Jam Tangan<i class="fas fa-chevron-right"></i></a></li>
										</ul>
									</li>
