							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									<li class="hassubs">
										...
										<ul>											
											<li><a href="pomi.php">Pojok MIPA<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="gww.php">Graha Widya Wisuda<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="alhur.php">Masjid Al-Hurriyyah<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="lsi.php">Perpustakaan LSI<i class="fas fa-chevron-right"></i></a></li>
										</ul>
									</li>
									...
									<li class="hassubs">
										...
										<ul>											
											<li><a href="gadget.php">Gadget<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="dompet.php">Dompet<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="alat tulis.php">Alat Tulis<i class="fas fa-chevron-right"></i></a></li>
											<li><a href="jam tangan.php">Jam Tangan<i class="fas fa-chevron-right"></i></a></li>
										</ul>
									</li>
			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						<h1 class="banner_text">Lost 'n Found IPB</h1>
						<div class="button banner_button"><a href="lostform.php">Laporkan Kehilangan</a></div>
						<div class="button banner_button"><a href="foundform.php">Laporkan Penemuan</a></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col">
					<div class="tabbed_container">
						<div class="tabs clearfix tabs-right">
							...
							<ul class="clearfix">
								<li class="active">Temuan Terbaru</li>
								<li>Kehilangan Terbaru</li>
							</ul>
								...
								<div class="bestsellers_item discount">
									<div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
										...
										<div class="bestsellers_content">
											...
											<div class="bestsellers_price discount">Lokasi : POMI</span></div>
										</div>
									</div>
