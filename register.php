...
<html lang="en">
<head>
<title>Register Lost & Found IPB</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<p><h2><b>Baru di Lost & Found IPB?</b></h2></p>
	<P>Silakan isi form ini.</p>
		<div class="registerform">
			<form action="/action_page.php">
			  <div class="form-group">
			    <label for="name">Nama:</label>
			    <input type="text" class="form-control" id="name" placeholder="Contoh: Bayu Pradana">
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input type="email" class="form-control" id="email" placeholder="Contoh: bayup@email.com">
			  </div>
			  <div class="form-group">
			    <label for="tel">Nomor HP:</label>
			    <input type="tel" class="form-control" id="tel" placeholder="Contoh: 080112345678">
			  </div>
			  <p><b>Sudah punya akun? Silakan <a href="signin.html">sign in</a>.</b></p>
